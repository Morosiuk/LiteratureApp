...
namespace API.Data.Migrations
{
    ...
    [Migration("20220221122853_AddSymbolToRequestItem")]
    partial class AddSymbolToRequestItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.RequestItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("LiteratureCode")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("API.Entities.RequestItem", b =>
                {
                    b.HasOne("API.Entities.LanguageCode", "LanguageCode")
                        .WithMany()
                        .HasForeignKey("LanguageCodeId");

                    b.HasOne("API.Entities.Literature", "Literature")
                        .WithMany()
